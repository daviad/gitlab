...
# treeUrl = 'https://192.168.0.101//api/v4/projects/94/repository/tree?ref=master&private_token=Y_9JmHyAnPmu9uAuCuy'
# filesUrl = 'https://192.168.0.101//api/v4/projects/94/repository/files/src/main/proto/sunflower.proto?ref=master&private_token=Y_9JmHyAnPmu9uAuCuy'
# files = requests.get(treeUrl,verify=False)

# d = files.json()
# print(d);
# gl = gitlab.Gitlab(“https://www.gitlab.de”, verify_ssl=False)
# gl.login(“admin”, “admin”)
# 登录
